...
% === IDIOMA: español (partición silábica, convenciones tipográficas) ===
...
\newcommand{\makenoveltitle}{%
  ...
  {\small\textsc{07}}\\[0.25in]
  {\Huge\textsc{Los Que Se Quedaron}}\\[0.4in]
  {\small------\quad$\diamond$\quad------}\\[0.5in]
  {\large\textit{Una novela}}\\[1in]
...
\newcommand{\makeepigraph}{%
  ...
  el Dios mío me oirá.»\\[12pt]
  \upshape\small --- Miqueas 7:7 (RVR1960)
  \end{center}
  \end{minipage}
  \end{center}
  \clearpage
...
\newcommand{\makehalftitle}{%
  ...
  \vspace*{3in}
  \begin{center}
  {\large\textsc{Los Que Se Quedaron}}
  \end{center}
  \clearpage
}
...
\usepackage{hyperref}
\hypersetup{
  pdftitle={Los Que Se Quedaron},
  pdfauthor={Chris Suazo},
  pdfsubject={Novela apocalíptica cristiana},
  hidelinks
}
